			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="container-login100-form-messages">
						...
						<div id="processing_message" class="alert alert-info" style="margin-bottom:30px;display:none;"><strong>Processing ...</strong></div>
						<div id="error_message" class="error_message"></div>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter Username">
						<input class="input100" type="text" name="user" id="inp_user">
				...
				<div class="footer" style="text-align:center;width:100%;margin-top:15px;">
					<a href="REDACTED">Return to Services Gateway</a>
				</div>
			</div>
		</div>
	</div>
